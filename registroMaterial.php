  ...
  <div class="main">
    ...
    <div class="view">
      ...
      <div class="container-fluid row">
        ...
        <form  class=" col-10 p-3 formulario" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <label for="exampleInputEmail1" class="input_textual">Selecciona el archivo</label>
            <!--Genera el espacio para introducir el nombre del administrador y envía el dato nombre
              ...
              -->
            <input type="file" class="form-control" name="archivo" accept=".pdf, .png" required>
          </div>
          
          
          <button type="submit" class="btn btn-outline-primary"  value="Subir archivo">Registrar</button>
        </form>    
    </div>
  </div>
</div>
